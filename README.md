...
5. Use the combat tracker context menu to assign a commander for a side.
...
- Right-click a combatant in the combat tracker to assign the commander for that side.
